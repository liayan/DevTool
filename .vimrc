...
let g:ycm_global_ycm_extra_conf='/Users/lyan/.vim/bundle/youcompleteme/cpp/.ycm_extra_conf.py'
...
let Tlist_Ctags_Cmd='/usr/local/bin/ctags'  "设置ctags的位置，不是指向MacOS自带的那个，而是我们用homebrew安装的那个
